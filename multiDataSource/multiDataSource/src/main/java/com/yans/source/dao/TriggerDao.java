...
public class TriggerDao extends BaseDao {
	...
	public Long create(Trigger t) {
		...
		sql.append(
				" INSERT INTO trigger_detail(check_id,condition_detail,js_script,is_right,name,is_file,group_id,descript,tg_follow,tg_redeliv_interval,tg_max_redeliv) ");
		sql.append(
				" VALUES(:check_id,:condition_detail,:js_script,is_right,:name,:is_file,:group_id,:descript,:tg_follow,:tg_redeliv_interval,:tg_max_redeliv)");
