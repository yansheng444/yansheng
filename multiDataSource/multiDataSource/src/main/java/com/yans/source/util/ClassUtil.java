...
public class ClassUtil {
    ...
    private static final Log logger = LogFactory.getLog("businessLog");
    
    private static final String CLASS_PATH	 = ClassUtil.class.getClass().getResource("/").toString();
   ...
   */
    private static String getFilePath(String file){
        ...
        return file.substring(0, last1>last2?last1:last2)+File.separator;
    }
    /**
   * 编译java文件
   * @param ops 编译参数
